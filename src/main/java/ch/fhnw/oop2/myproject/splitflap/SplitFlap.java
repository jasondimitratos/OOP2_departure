...
public class SplitFlap extends Region {
    ...
    private              Image    bkgImg           = new Image(SplitFlap.class.getResource("/splitflap/background.png").toExternalForm());
    private              Image    flpImg           = new Image(SplitFlap.class.getResource("/splitflap/flap.png").toExternalForm());
